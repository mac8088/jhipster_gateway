...
import net.atos.demo.config.audit.AuditEventConverter;
import net.atos.demo.domain.PersistentAuditEvent;
...
import static net.atos.demo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
